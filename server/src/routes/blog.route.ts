...
router.post("/",authenticateJWT,authorizeRole("user"),upload.single("image"),BlogController.create)
router.put("/:id",authenticateJWT,authorizeRole("user"),upload.single("image"),BlogController.update)
